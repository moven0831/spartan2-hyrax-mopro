...
pub use crate::setup::{load_keys, load_proving_key, setup_ecdsa_keys, setup_jwt_keys};
...
/// NOTE: This function is currently disabled as prove_sum_check is not available in zk_spartan::R1CSSNARK
#[allow(dead_code)]
pub fn prove_jwt_sum_check() -> Result<(u128, u128), Box<dyn std::error::Error>> {
    unimplemented!("prove_sum_check is not available in zk_spartan::R1CSSNARK implementation")
}
