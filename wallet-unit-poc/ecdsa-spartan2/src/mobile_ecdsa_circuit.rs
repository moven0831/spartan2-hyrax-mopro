...
/// Mobile-compatible ECDSA circuit that uses pre-generated witnesses
#[derive(Debug, Clone)]
pub struct MobileECDSACircuit;

impl SpartanCircuit<E> for MobileECDSACircuit {
    fn synthesize<CS: ConstraintSystem<Scalar>>(
        ...
        let r1cs_file = witness_dir.join("ecdsa.r1cs");
        let witness_file = witness_dir.join("ecdsa.wtns");
